...
test('unbalancedFfa', function *(t) {
  ...
  var tbm = tb.matches;
  t.eq(tbm.length, 2, 'two matches in tbm');
  t.eq(tbm[0].p, [1,3,6], 's1 tiebreaker 1');
  t.eq(tbm[1].p, [4,5,7], 's1 tiebreaker 2');
  ...
  t.eq(tb2m.length, 2, 'two matches in tb2m');
  t.eq(tb2m[0].p, [1,3,6], 'r1 tiebreaker 1');
  t.eq(tb2m[1].p, [4,5,7], 'r1 tiebreaker 2');
  ...
  t.eq(tb3m.length, 2, 'two matches in tb3m');
  t.eq(tb3m[0].p, [1,3,6], 's1 tiebreaker 1');
  t.eq(tb3m[1].p, [4,5], 's1 tiebreaker 2 smaller now');
  ...
  t.eq(tb4m.length, 1, 'only 1 match in tb4m');
  t.eq(tb4m[0].p, [1,3,6], 's1 tiebreaker 1');
